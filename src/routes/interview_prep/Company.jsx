...
export default function Company() {
  ...
  return (
    <div className="w-full h-full bg-purple-50 flex p-10">
      {/* Filter Section */}
  ...
  {filteredCompanies.length > 0 ? (
    filteredCompanies.map((company) => (
      <div key={company.id} className="bg-white shadow-lg rounded-lg p-6 transition-transform transform hover:scale-105 hover:shadow-xl">
        <div className="flex items-center gap-4 mb-4">
          ...
          />
          <h3 className="text-2xl font-bold text-purple-700">{company.name}</h3>
        </div>
        <div className="flex justify-between items-center">
          <p className="text-purple-600 mb-2">Industry: {company.industry}</p>
