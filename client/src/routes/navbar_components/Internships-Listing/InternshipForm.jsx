  ...
  return (
    <div className="max-w-4xl mx-auto p-4 bg-gray-100">
      ...
      <form onSubmit={handleSubmit} className="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
        <h2 className="text-2xl font-bold mb-6 text-center bg-gradient-to-r from-purple-600 to-blue-500 text-transparent bg-clip-text">Internship Application Form</h2>
        ...
        <div className="mb-4">
          <RequiredLabel htmlFor="graduationYear">Expected Graduation Year</RequiredLabel>
          <input
            className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
            id="graduationYear"
            type="number"
        ...
        <div className="mb-4">
          <RequiredLabel htmlFor="coverLetter">Upload Cover Letter</RequiredLabel>
          <input
            className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
            id="coverLetter"
            type="file"
