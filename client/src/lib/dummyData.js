...
export const mockInterviewData = [
  {
    ...
    questions: {
      easy: ["What is React?", "Explain hooks in React.", "What is Redux?"],
      medium: [
  ...
  },
  {
    ...
    position: "Backend Developer",
    image:
      "https://img.freepik.com/free-photo/joint-work-talented-programmers_1098-17280.jpg",
    questions: {
      easy: [
        "What is Node.js?",
  ...
  },
  {
    ...
    image:
      "https://img.freepik.com/free-photo/side-view-attractive-hispanic-software-developer-programming-using-computer-while-working-from-home_662251-958.jpg",
    questions: {
      easy: [
  ...
  },
  {
    ...
    position: "Data Scientist",
    image:
      "https://img.freepik.com/free-photo/back-shot-overwhelmed-woman-working-night-front-computer-writing-notes-notebook-annual-reports-checking-financial-deadline_482257-5154.jpg",
    questions: {
      easy: [
  ...
  },
  {
    ...
    position: "UI UX Designer",
    image:
      "https://img.freepik.com/free-vector/interaction-design-concept-illustration_114360-4520.jpg",
    questions: {
      easy: [
        "What is UI/UX?",
        "Explain how it works in real life.",
  ...
  },
  {
    ...
    position: "Content Writer",
    image:
      "https://img.freepik.com/free-vector/content-author-writer-job-concept_74855-7064.jpg",
    questions: {
      easy: [
  ...
  },
  {
    ...
    position: "Product Manager",
    image:
      "https://img.freepik.com/free-photo/portrait-asian-woman-business-owner-using-digital-tablet-checking-amount-stock-product-inventory-shelf-distribution-warehouse-factorylogistic-business-shipping-delivery-service_609648-2022.jpg",
    questions: {
      easy: [
  ...
  },
  {
    ...
    image:
      "https://img.freepik.com/free-photo/consulting-with-colleague_1098-15099.jpg",
    questions: {
      easy: [
...
export const practiceData = [
      ...
      HTML: [
        {
          ...
          resources:
            "https://www.geeksforgeeks.org/how-to-build-a-responsive-navigation-bar-with-flexbox/",
          completed: false,
        },
        {
          task: "Implement a form with validation.",
          resources:
            "https://www.geeksforgeeks.org/form-validation-using-javascript/",
          completed: false,
        },
        {
          task: "Create a semantic HTML structure for SEO.",
          resources:
            "https://www.geeksforgeeks.org/seo-friendly-web-development-using-html-and-css/",
          completed: false,
        },
      ],
      CSS: [
        {
          task: "Optimize a web page for performance.",
          resources:
            "https://www.geeksforgeeks.org/7-tips-for-performances-optimization-in-web-development/",
          completed: false,
        },
        {
          task: "Use CSS Grid and Flexbox to build a layout.",
          resources:
            "https://www.geeksforgeeks.org/how-to-create-a-flexbox-grid/",
          completed: false,
        },
        {
          task: "Create CSS animations for UI elements.",
          resources: "https://www.geeksforgeeks.org/css-animations/",
          completed: false,
        },
      ],
      JavaScript: [
        {
          task: "Implement dynamic form validation using JavaScript.",
          resources:
            "https://www.geeksforgeeks.org/form-validation-using-javascript/",
          completed: false,
        },
        {
          task: "Build a single-page application (SPA) with vanilla JavaScript.",
          resources:
            "https://www.geeksforgeeks.org/building-spa-using-vanilla-javascript/",
          completed: false,
        },
        {
          task: "Use the Fetch API to make API calls.",
          resources: "https://www.geeksforgeeks.org/fetch-api-javascript/",
          completed: false,
        },
      ],
      ResponsiveDesign: [
        {
          task: "Create a fully responsive grid system.",
          resources:
            "Create a fully responsive grid system.",
          completed: false,
        },
        {
          task: "Implement media queries for mobile-first design.",
          resources:
            "https://www.geeksforgeeks.org/how-to-use-media-queries-in-a-mobile-first-approach-in-html/",
          completed: false,
        },
        {
          task: "Optimize images for different screen sizes.",
          resources:
            "https://www.geeksforgeeks.org/responsive-images-in-web-design/",
          completed: false,
        },
      ],
      Testing: [
        {
          task: "Write unit tests using Jest for JavaScript components.",
          resources:
            "https://www.geeksforgeeks.org/unit-testing-javascript-applications-using-jest/",
          completed: false,
        },
        {
          task: "Perform cross-browser testing with Selenium.",
          resources:
            "https://www.geeksforgeeks.org/cross-browser-testing-using-selenium/",
          completed: false,
        },
        {
          task: "Debug and test performance using Chrome DevTools.",
          resources:
            "https://www.geeksforgeeks.org/debugging-with-chrome-devtools/",
          completed: false,
        },
      ],
    },
  },
  {
    ...
    tasks: {
      NodeJS: [
        {
          task: "Set up a Node.js project with Express.",
          resources: "https://www.geeksforgeeks.org/express-js-introduction/",
          completed: false,
        },
        {
          task: "Implement JWT-based authentication.",
          resources: "https://www.geeksforgeeks.org/json-web-token-jwt/",
          completed: false,
        },
        {
          task: "Use middleware for logging and error handling.",
          resources: "https://www.geeksforgeeks.org/middleware-in-node-js/",
          completed: false,
        },
      ],
      Database: [
        {
          task: "Design a schema using MongoDB and Mongoose.",
          resources:
            "https://www.geeksforgeeks.org/mongoose-schemas-creating-a-model/#:~:text=To%20create%20a%20model%20with,interaction%20with%20the%20MongoDB%20collection.",
          completed: false,
        },
        {
          task: "Create database relationships in PostgreSQL.",
          resources:
            "https://www.geeksforgeeks.org/postgresql-create-database/",
          completed: false,
        },
        {
          task: "Perform data migrations with Knex.js.",
          resources: "https://www.geeksforgeeks.org/objection-js-sql-friendly-orm-for-node-js/",
          completed: false,
        },
      ],
      APIs: [
        {
          task: "Create a RESTful API with Express and Node.js.",
          resources:
            "https://www.geeksforgeeks.org/build-a-restful-api-using-node-js-and-express-js/",
          completed: false,
        },
        {
          task: "Implement rate limiting in your API.",
          resources:
            "https://www.geeksforgeeks.org/rate-limiting-using-node-js/",
          completed: false,
        },
        {
          task: "Use GraphQL to build a flexible API.",
          resources: "https://www.geeksforgeeks.org/graphql-using-nodejs/",
          completed: false,
        },
      ],
      Security: [
        {
          task: "Implement data encryption with bcrypt.",
          resources:
            "https://www.geeksforgeeks.org/password-encryption-in-node-js-using-bcryptjs-module/",
          completed: false,
        },
        {
          task: "Set up HTTPS with SSL/TLS.",
          resources:
            "https://www.geeksforgeeks.org/secure-socket-layer-ssl/",
          completed: false,
        },
        {
          task: "Use Helmet.js for securing HTTP headers.",
          resources:
      ...
      Testing: [
        {
          task: "Write unit tests for Node.js with Mocha.",
          resources:
            "https://www.geeksforgeeks.org/mocha-javascript-unit-testing-framework/",
          completed: false,
        },
        {
          task: "Test APIs using Postman and Newman.",
          resources:
            "https://www.geeksforgeeks.org/how-to-test-apis-using-postman/",
          completed: false,
        },
        {
          task: "Use Chai.js for assertion testing.",
          resources:
            "https://www.geeksforgeeks.org/assertion-testing-with-chai/",
          completed: false,
        },
      ],
    },
  },
  {
    ...
    tasks: {
      MERNStack: [
        {
          task: "Build a full-stack MERN application.",
          resources: "https://www.geeksforgeeks.org/mern-stack/",
          completed: false,
        },
        {
          task: "Set up a React frontend and Express backend.",
          resources:
            "https://www.geeksforgeeks.org/how-to-connect-node-js-with-react-js/",
          completed: false,
        },
        {
          task: "Use Redux for state management in a React app.",
          resources:
      ...
      Authentication: [
        {
          task: "Implement OAuth2.0 for user login.",
          resources:
            "https://www.geeksforgeeks.org/oauth-2-0-authorization-framework/",
          completed: false,
        },
        {
          task: "Use Passport.js for authentication in Node.js.",
          resources:
            "https://www.geeksforgeeks.org/nodejs-authentication-using-passportjs-and-passport-local-mongoose/",
          completed: false,
        },
        {
          task: "Integrate Firebase authentication in a React app.",
          resources:
            "https://www.geeksforgeeks.org/firebase-authentication-in-react-apps/",
          completed: false,
        },
      ],
      Deployment: [
        {
          task: "Deploy a MERN app using Heroku.",
          resources:
            "https://www.geeksforgeeks.org/how-to-deploy-node-js-app-on-heroku-from-github/",
          completed: false,
        },
        {
          task: "Set up CI/CD pipelines with GitHub Actions.",
          resources:
            "https://www.geeksforgeeks.org/github-actions-cicd-pipeline-for-node-js-app/",
          completed: false,
        },
        {
          task: "Deploy a React app using Netlify.",
          resources:
      ...
      Testing: [
        {
          task: "Write end-to-end tests with Cypress.",
          resources:
            "https://www.geeksforgeeks.org/automation-testing-using-cypress-tool/",
          completed: false,
        },
        {
          task: "Use Jest for testing React components.",
          resources:
            "https://www.geeksforgeeks.org/testing-react-components-using-jest/",
          completed: false,
        },
        {
          task: "Write integration tests for Express APIs.",
          resources:
            "https://www.geeksforgeeks.org/integration-testing-of-rest-api-using-mocha-chai-and-postman/",
          completed: false,
        },
      ],
    },
  },
  {
    ...
    tasks: {
      DataCleaning: [
        {
          task: "Clean a dataset using Pandas.",
          resources:
            "https://www.geeksforgeeks.org/data-cleaning-in-python-using-pandas/",
          completed: false,
        },
        {
          task: "Handle missing data and outliers.",
          resources:
            "https://www.geeksforgeeks.org/handling-missing-values-in-machine-learning/",
          completed: false,
        },
        {
          task: "Normalize and standardize data.",
          resources:
      ...
      EDA: [
        {
          task: "Perform exploratory data analysis on a dataset.",
          resources:
            "https://www.geeksforgeeks.org/exploratory-data-analysis-in-python/",
          completed: false,
        },
        {
          task: "Visualize data distributions with Seaborn.",
          resources:
            "https://www.geeksforgeeks.org/data-visualization-using-seaborn/",
          completed: false,
        },
        {
          task: "Analyze feature correlations with heatmaps.",
          resources:
            "https://www.geeksforgeeks.org/correlation-matrix-heatmap-using-seaborn/",
          completed: false,
        },
      ],
      MachineLearning: [
        {
          task: "Train a linear regression model in Python.",
          resources:
            "https://www.geeksforgeeks.org/linear-regression-in-python/",
          completed: false,
        },
        {
        ...
        {
          task: "Evaluate model performance using cross-validation.",
          resources:
      ...
      DeepLearning: [
        {
          task: "Build a neural network with TensorFlow.",
          resources:
            "https://www.geeksforgeeks.org/deep-learning-tensorflow-tutorial/",
          completed: false,
        },
        {
          task: "Train a CNN for image classification.",
          resources:
            "https://www.geeksforgeeks.org/convolutional-neural-network-cnn/",
          completed: false,
        },
        {
          task: "Implement transfer learning for a pre-trained model.",
          resources:
            "https://www.geeksforgeeks.org/transfer-learning-in-deep-learning/",
          completed: false,
        },
      ],
      Deployment: [
        {
          task: "Deploy a machine learning model with Flask.",
          resources:
            "https://www.geeksforgeeks.org/deploy-machine-learning-model-using-flask/",
          completed: false,
        },
        {
          task: "Use Docker to containerize a machine learning app.",
          resources:
            "https://www.geeksforgeeks.org/containerizing-ml-model-flask-app-with-docker/",
          completed: false,
        },
        {
          task: "Deploy a model using AWS SageMaker.",
          resources:
            "https://www.geeksforgeeks.org/amazon-sagemaker-deploying-machine-learning-models/",
          completed: false,
        },
      ],
    },
  },
  {
    ...
    tasks: {
      Prototyping: [
        {
          task: "Create wireframes for a mobile app in Figma.",
          resources:
            "https://www.geeksforgeeks.org/prototyping-tools-in-ui-ux-design-figma/",
          completed: false,
        },
        {
          task: "Design an interactive prototype using Adobe XD.",
          resources:
            "https://www.geeksforgeeks.org/creating-prototypes-in-adobe-xd/",
          completed: false,
        },
        {
          task: "Test a prototype with potential users.",
          resources:
            "https://www.geeksforgeeks.org/usability-testing-of-wireframes-and-prototypes/",
          completed: false,
        },
      ],
      UserResearch: [
        {
          task: "Conduct user interviews to gather feedback.",
          resources:
            "https://www.geeksforgeeks.org/user-interview-in-ux-research/",
          completed: false,
        },
        {
          task: "Create user personas based on research.",
          resources:
            "https://www.geeksforgeeks.org/user-persona-in-ux-research/",
          completed: false,
        },
        {
          task: "Analyze usability test results for improvement.",
          resources:
            "https://www.geeksforgeeks.org/analyze-usability-test-results-in-ux-design/",
          completed: false,
        },
      ],
      VisualDesign: [
        {
          task: "Design a color scheme for a web app.",
          resources:
            "https://www.geeksforgeeks.org/color-theory-in-ui-ux-design/",
          completed: false,
        },
        {
          task: "Create UI components with consistent typography.",
          resources:
            "https://www.geeksforgeeks.org/typography-in-ui-ux-design/",
          completed: false,
        },
        {
          task: "Use grid systems for layout design.",
          resources: "https://www.geeksforgeeks.org/grid-systems-in-ui-design/",
          completed: false,
        },
      ],
      Accessibility: [
        {
          task: "Ensure accessibility compliance with WCAG.",
          resources:
            "https://www.geeksforgeeks.org/web-content-accessibility-guidelines-wcag/",
          completed: false,
        },
        {
          task: "Design for screen readers and keyboard navigation.",
          resources:
            "https://www.geeksforgeeks.org/designing-for-accessibility-in-ui-ux/",
          completed: false,
        },
        {
          task: "Test contrast ratios for better readability.",
          resources:
            "https://www.geeksforgeeks.org/accessibility-testing-for-contrast-ratio/",
          completed: false,
        },
      ],
    },
...

  {
    ...
    tasks: {
      Design: [
        {
          task: "Design a logo using Adobe Illustrator.",
          resources:
            "https://www.geeksforgeeks.org/adobe-illustrator-logo-design/",
          completed: false,
        },
        {
          task: "Create social media graphics for a brand.",
          resources:
            "https://www.geeksforgeeks.org/designing-social-media-posts-in-photoshop/",
          completed: false,
        },
        {
          task: "Design a flyer for an event.",
          resources:
            "https://www.geeksforgeeks.org/how-to-design-an-event-flyer/",
          completed: false,
        },
      ],
      Branding: [
        {
          task: "Design a print-ready business card.",
          resources:
            "https://www.geeksforgeeks.org/designing-a-business-card-in-adobe-illustrator/",
          completed: false,
        },
        {
          task: "Develop a brand color palette and typography.",
          resources:
            "https://www.geeksforgeeks.org/creating-brand-color-palette-in-design/",
          completed: false,
        },
        {
          task: "Create a brand style guide.",
          resources:
            "https://www.geeksforgeeks.org/creating-a-brand-style-guide/",
          completed: false,
        },
      ],
      Illustration: [
        {
          task: "Create digital illustrations for marketing materials.",
          resources:
            "https://www.geeksforgeeks.org/how-to-create-digital-illustrations/",
          completed: false,
        },
        {
          task: "Illustrate a children's book.",
          resources:
            "https://www.geeksforgeeks.org/illustrating-a-childrens-book/",
          completed: false,
        },
      ],
      Typography: [
        {
          task: "Choose typography for a website.",
          resources: "https://www.geeksforgeeks.org/typography-in-web-design/",
          completed: false,
        },
        {
          task: "Create custom fonts for branding.",
          resources:
            "https://www.geeksforgeeks.org/how-to-create-custom-fonts/",
          completed: false,
        },
      ],
    },
      ...
      SEO: [
        {
          ...
          resources:
            "https://www.geeksforgeeks.org/seo-content-writing-tips-for-beginners/",
          completed: false,
        },
        {
          task: "Create a content calendar for a website.",
          resources:
            "https://www.geeksforgeeks.org/how-to-create-a-content-calendar-for-a-website/",
          completed: false,
        },
        {
          task: "Conduct keyword research for content.",
          resources: "https://www.geeksforgeeks.org/keyword-research-in-seo/",
          completed: false,
        },
      ],
      Editing: [
        {
          task: "Write engaging social media posts.",
          resources:
            "https://www.geeksforgeeks.org/writing-social-media-content-to-engage-users/",
          completed: false,
        },
        {
          task: "Edit content for grammar and readability.",
          resources:
            "https://www.geeksforgeeks.org/content-editing-tips-for-better-readability/",
          completed: false,
        },
        {
          task: "Proofread articles before publication.",
          resources:
            "https://www.geeksforgeeks.org/proofreading-tips-for-content-writers/",
          completed: false,
        },
      ],
      Research: [
        {
          task: "Research industry trends for content ideas.",
          resources:
            "https://www.geeksforgeeks.org/researching-industry-trends-for-content/",
          completed: false,
        },
        {
          task: "Analyze competitor content strategies.",
          resources:
            "https://www.geeksforgeeks.org/analyzing-competitor-content-strategies/",
          completed: false,
        },
      ],
      ContentStrategy: [
        {
          task: "Develop a content strategy for a blog.",
          resources:
            "https://www.geeksforgeeks.org/developing-a-content-strategy/",
          completed: false,
        },
        {
          task: "Plan content for a product launch.",
          resources:
            "https://www.geeksforgeeks.org/content-planning-for-product-launch/",
          completed: false,
        },
      ],
    },
  },
  {
    ...
    tasks: {
      Roadmapping: [
        {
          task: "Create a product roadmap for a new feature.",
          resources:
            "https://www.geeksforgeeks.org/how-to-create-a-product-roadmap/",
          completed: false,
        },
        {
          task: "Define key performance indicators (KPIs) for a product.",
          resources:
            "https://www.geeksforgeeks.org/defining-kpis-for-product-management/",
          completed: false,
        },
        {
          task: "Prioritize features based on user feedback.",
          resources:
            "https://www.geeksforgeeks.org/prioritizing-product-features/",
          completed: false,
        },
      ],
      Research: [
        {
          task: "Conduct market research and analyze competitors.",
          resources:
            "https://www.geeksforgeeks.org/how-to-conduct-market-research-for-product/",
          completed: false,
        },
        {
          task: "Work with a cross-functional team to plan a sprint.",
          resources:
            "https://www.geeksforgeeks.org/sprint-planning-in-product-management/",
          completed: false,
        },
        {
          task: "Gather user requirements for product development.",
          resources:
            "https://www.geeksforgeeks.org/gathering-user-requirements/",
          completed: false,
        },
      ],
      StakeholderManagement: [
        {
          task: "Communicate product updates to stakeholders.",
          resources:
            "https://www.geeksforgeeks.org/communicating-product-updates/",
          completed: false,
        },
        {
          task: "Facilitate stakeholder meetings and discussions.",
          resources:
            "https://www.geeksforgeeks.org/facilitating-stakeholder-meetings/",
          completed: false,
        },
      ],
      LaunchPlanning: [
        {
          task: "Plan a go-to-market strategy for a new product.",
          resources:
            "https://www.geeksforgeeks.org/planning-go-to-market-strategy/",
          completed: false,
        },
        {
          task: "Coordinate product launch activities.",
          resources:
            "https://www.geeksforgeeks.org/coordinating-product-launch-activities/",
          completed: false,
        },
      ],
    },
  },
  {
    ...
    tasks: {
      SoftwareDevelopment: [
        {
          task: "Develop a software system with object-oriented principles.",
          resources:
            "https://www.geeksforgeeks.org/object-oriented-programming-oops-concept-in-java/",
          completed: false,
        },
        {
          task: "Implement data structures and algorithms in a project.",
          resources:
            "https://www.geeksforgeeks.org/data-structures-and-algorithms-overview/",
          completed: false,
        },
        {
          task: "Design RESTful APIs for the application.",
          resources:
            "https://www.geeksforgeeks.org/designing-restful-apis-in-node-js/",
          completed: false,
        },
      ],
      Testing: [
        {
          ...
          resources:
            "https://www.geeksforgeeks.org/unit-testing-in-software-engineering/",
          completed: false,
        },
        {
          task: "Optimize the application for scalability.",
          resources:
            "https://www.geeksforgeeks.org/optimizing-applications-for-scalability/",
          completed: false,
        },
        {
          task: "Conduct performance testing.",
          resources:
            "https://www.geeksforgeeks.org/performance-testing-in-software-engineering/",
          completed: false,
        },
      ],
      VersionControl: [
        {
          ...
          resources:
            "https://www.geeksforgeeks.org/git-version-control-system/",
          completed: false,
        },
        {
          task: "Collaborate on code reviews using GitHub.",
          resources:
            "https://www.geeksforgeeks.org/code-review-best-practices/",
          completed: false,
        },
      ],
      Deployment: [
        {
          task: "Deploy applications using cloud services.",
          resources:
            "https://www.geeksforgeeks.org/deploying-applications-on-cloud/",
          completed: false,
        },
        {
          task: "Automate deployment with CI/CD pipelines.",
          resources:
            "https://www.geeksforgeeks.org/what-is-ci-cd-and-how-to-use-it/",
          completed: false,
        },
      ],
    },
  },
  {
    ...
    tasks: {
      Visualization: [
        {
          task: "Create dashboards using data visualization tools.",
          resources:
            "https://www.geeksforgeeks.org/data-visualization-using-power-bi/",
          completed: false,
        },
        {
          task: "Use Power BI or Tableau to present insights.",
          resources: "https://www.geeksforgeeks.org/introduction-to-tableau/",
          completed: false,
        },
        {
          task: "Design interactive reports for stakeholders.",
          resources:
            "https://www.geeksforgeeks.org/creating-interactive-reports-in-tableau/",
          completed: false,
        },
      ],
      Analysis: [
        {
          task: "Analyze datasets using Excel or SQL.",
          resources: "https://www.geeksforgeeks.org/sql-for-data-analysis/",
          completed: false,
        },
        {
          task: "Perform statistical analysis to find trends.",
          resources:
            "https://www.geeksforgeeks.org/statistical-analysis-in-data-science/",
          completed: false,
        },
        {
          task: "Create predictive models using data.",
          resources:
            "https://www.geeksforgeeks.org/predictive-analytics-using-data-science/",
          completed: false,
        },
      ],
      DataCleaning: [
        {
          task: "Clean and preprocess data for analysis.",
          resources:
            "https://www.geeksforgeeks.org/data-cleaning-in-data-science/",
          completed: false,
        },
        {
          task: "Handle missing values in datasets.",
          resources: "https://www.geeksforgeeks.org/dealing-with-missing-data/",
          completed: false,
        },
      ],
      Reporting: [
        {
          task: "Prepare reports for management review.",
          resources:
            "https://www.geeksforgeeks.org/how-to-create-reports-in-excel/",
          completed: false,
        },
        {
          task: "Communicate findings effectively to stakeholders.",
          resources:
            "https://www.geeksforgeeks.org/how-to-communicate-data-analytics-findings/",
          completed: false,
        },
      ],
    },
...
export const jobListings = [
  {
    ...
    aboutCompany:
      "Surge Technology Solutions is a one stop BPM solution provider offering digitally driven Business Process Management solutions for businesses across various industries.",
  },
  {
    id: 2,
    ...
    aboutCompany:
      "TechInnovate Solutions is a leading software development company specializing in creating cutting-edge web and mobile applications.",
  },
  {
    id: 7,
    title: "Backend Developer",
  ...
  },
  {
    ...
    aboutCompany:
      "DataMind Analytics is a data-driven company that provides advanced analytics solutions to businesses across various industries.",
  },
  {
    id: 4,
    ...
    aboutCompany:
      "CloudTech Systems is a cloud solutions provider specializing in helping businesses migrate and optimize their infrastructure on cloud platforms.",
  },
  {
    id: 5,
    ...
    aboutCompany:
      "CreativePixel Design Studio is a boutique design agency known for creating beautiful and functional digital experiences for startups and enterprises alike.",
  },
  {
    id: 6,
    ...
    aboutCompany:
      "InnovateTech Solutions is a fast-growing SaaS company that provides cutting-edge business management solutions to enterprises worldwide.",
  },
];
...
export const internshipListings = [
  {
    ...
    aboutCompany:
      "TechStart is an innovative startup focused on creating cutting-edge mobile applications.",
  },
  {
    id: 2,
    ...
    aboutCompany:
      "CodeCraft is a leading software development company specializing in web and mobile applications.",
  },
  {
    id: 3,
    ...
    aboutCompany:
      "DataMinds is a pioneering AI research company focusing on developing innovative machine learning solutions.",
  },
  {
    id: 4,
    ...
    aboutCompany:
      "CreativeHub is a dynamic design agency known for its innovative and eye-catching visual solutions.",
  },
  {
    id: 5,
    ...
    aboutCompany:
      "WordCraft is a content creation agency that provides high-quality written content for businesses across various industries.",
  },
  {
    id: 6,
    ...
    aboutCompany:
      "AppNova is a mobile app development company known for creating innovative and user-friendly applications for both iOS and Android platforms.",
  },
];
